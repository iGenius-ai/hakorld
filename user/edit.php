...
<html lang="en">
  <head>
    ...
    <title>Hakorld - Edit Paper</title>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-10" id="content">
          ...
          <legend>Proposal Status: Being Edited</legend>

					<form id="saveSubmission" action="edit.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
            ...
            <input type="hidden" name="id" value="<?php echo $id ?>">
		          ...
		          <button type="submit" name="update-proposal" id="submitProposalBtn" class="btn btn-primary">Update Proposal</button>
				      <br>
		          <div style="color:#a94442">
		            <span class="glyphicon glyphicon-remove" aria-hidden="true"></span><strong>Kindly ensure that you go through your edits before updating the proposal.</strong>
		          </div>
			      </div>
