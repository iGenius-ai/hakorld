...
<html lang="en">	
  <head>
    ...
    <title>Hakorld &reg; - Recent News</title>
  </head>
  <body class="alt">
      ...
      <a id=skipLink></a>
      <h2 class="pageTitle uppercase">Recent News</h2>
      ...
      <div class="sixteen columns" id="maincontent">
        ...
        <section class="nine columns omega">
          ...
          <article class="nine columns post alpha" id="dc31cft">
            <a href="https://training.defcon.org/"><h2 class="title">Hakorld Training Announcement: 2023 Call for Trainers is open!</h2></a>
	          <p class="byline"> Posted 12.16.22</p>
	          <a href="https://training.defcon.org/"><img class="postImageFloat scale-with-grid" src="assets/images/dct_ann.webp" alt="Hakorld Training announcement logo" width="300" height="121" loading="lazy" decoding="async"/></a>
            <p>
              We're expanding our Hakorld Training in 2023 to include events in Seattle, 
              Las Vegas and Singapore,and we are looking for trainers! If you've got 
              experience and the kind of info hackers and security researchers can use, 
              this means you. Please consider applying - all the information you need 
              is available at <a href="https://training.defcon.org">https://training.defcon.org</a>.
            </p>
          </article>
        
          <article class="nine columns post alpha" id="dc31callcne">    
            <a href="../defcon-31/dc-31-cfce.html"><h2 class="title">Call for Contests &amp; Events is Now Open!</h2></a>
	          <p class="byline"> Posted 12.9.22</p>
	          <a href="../defcon-31/dc-31-cfce.html"><img class="postImageFloat scale-with-grid" src="assets/images/call-ideas.webp" alt="Hakorld 31 Call for ideas art" width="300" height="300" loading="lazy" decoding="async"/></a>
            <p>
              We've got a big Hakorld 31 announcement - the official 
              <a href="../defcon-31/dc-31-cfce.html">Call for Contests and Events</a> 
              is OPEN!<br><br>
              Now is the time to take the secret ideas you've been percolating and 
              share them with us. We're looking for new ideas and cool twists on more 
              familiar ones. Pitch us something good and we'll work with you to perfect 
              it and  get it on the floor in Las Vegas.<br><br>
              The rules and requirements await your examination. Hit us up with any 
              questions at info@defcon.org.<br><br>
